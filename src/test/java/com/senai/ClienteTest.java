...
public class ClienteTest {
	...
	void Cliente() {
		...
		cli.setNome("Jose Franca");
		cli.setCpfOuCnpj("12312312312");
		cli.setEmail("zefranca@gmail.com.br");
	...
	public void idCliente() {
		...
		assertEquals("Pedro Henrique F Sousa", cliente.getNome());
	}
	
	@Test
	public void updateCliente() {
		Cliente cliente = clienteRepo.findById(2).get();
		cliente.setNome("Narcos da Silva");
		clienteRepo.save(cliente);
		assertNotEquals("Narcos Jorge Júnior", cliente.getNome());
	}
